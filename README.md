...
AZAT is a standalone desktop application for researchers working with small-molecule ligands. It unifies essential pre-processing steps — from SMILES input to 3D conformational ensembles — into a single, interactive workflow.
